...
class ColaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborator" do
    assert_difference("Colaborator.count") do
      post colaborators_url, params: { colaborator: { available: @colaborator.available, byo: @colaborator.byo, email: @colaborator.email, name: @colaborator.name } }
    end
  ...
  test "should update colaborator" do
    patch colaborator_url(@colaborator), params: { colaborator: { available: @colaborator.available, byo: @colaborator.byo, email: @colaborator.email, name: @colaborator.name } }
